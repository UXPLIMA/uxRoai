...
contextBridge.exposeInMainWorld("uxRoaiStudio", {
  ...
  createTask: (prompt, projectId, history, attachments) => ipcRenderer.invoke("tasks:create", prompt, projectId, history, attachments),
  ...
  deleteTaskHistory: (projectId, taskId) => ipcRenderer.invoke("tasks:history:delete", projectId, taskId),
  ...
  renameTaskHistory: (projectId, taskId, newPrompt) => ipcRenderer.invoke("tasks:history:rename", projectId, taskId, newPrompt),
